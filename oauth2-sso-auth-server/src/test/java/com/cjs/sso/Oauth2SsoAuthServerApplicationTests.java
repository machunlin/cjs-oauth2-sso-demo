...
public class Oauth2SsoAuthServerApplicationTests {
    ...
    //clientId
    final static String CLIENT_ID = "OrderManagement";
    //clientSecret
    ...
    public void getUserInfo() throws Exception {
        ...
        log.info("用户信息返回的结果={}", JacksonHelper.toJson(result));
    }
...
//        log.info("登录信息返回的结果={}", JacksonHelper.toJson(result));
//    }
    ...
    private String getAccessToken() {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
        headers.add("authorization", getBasicAuthHeader(CLIENT_ID, CLIENT_SECRET));
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ...
        log.info("accessToken={}", JacksonHelper.toJson(t));
